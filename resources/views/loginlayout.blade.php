...
function check(){
    if ($("#seeAnotherField").val() == "Registered Business") {
      $('#otherFieldDiv').show();
		 $('#Corporate_Registration_Document_Div').show();
		$('#Resolution_of_Directors_authorizing_Application_Div').show();
		$('#Corporate_ID_Div').show();
		$('#invoices_from_suppliers_div').show();
		$('#Bank_void_check_Div').show();
		$('#statements_up_to_6_months_Div').show();
		$('#acquiring_Bank_for_fraud_Div').show();
      ...
      $('#otherFieldDiv').hide();
		 $('#Corporate_Registration_Document_Div').hide();
		 $('#Resolution_of_Directors_authorizing_Application_Div').hide();
		$('#Corporate_ID_Div').hide();
		$('#Bank_void_check_Div').hide();
		$('#invoices_from_suppliers_div').hide();
		$('#statements_up_to_6_months_Div').hide();
		$('#acquiring_Bank_for_fraud_Div').hide();
