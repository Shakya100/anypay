    ...
    <div class="container">
        <div class="row full-screen align-items-center p-50px-tb lg-p-100px-t justify-content-center">
            <div class="col-lg-6 m-50px-tb md-m-20px-t">
				...
				<div class="m-15px-tb">
				<img src="https://anypay.ph/head_card.png">
				</div>
				</div>
    ...
    <div class="container">
        <div class="row flex-row-reverse">
            <div class="col-lg-12 m-30px-b align-self-center">
				...
				<h3 class="text-center display-4 black-color mt-5">Our Valuable Partners</h3>
				
                <img class="rounded mx-auto d-block" src="{{url('/')}}/asset/images/logo_we_partner.png" title="" alt="">
    ...
    <div class="container">
        <div class="row justify-content-center md-m-25px-b m-40px-b">
            <div class="col-lg-6 text-center">
                <h3 class="h1 m-0px">{{__('Start accepting payments with')}} {{$set->site_name}} {{__('today.')}}</h3>
                <div class="p-20px-t">
