        ...
        <div class="row">
            <div class="col-lg-12 m-15px-tb">
                <div class="row md-m-25px-b m-40px-b">
                    <div class="col-lg-12">
                        <h3 class="h1 m-15px-b">{{__('How can we help you today?')}}</h3>
                ...
                <form class="rd-mailform" method="post" action="{{route('contact-submit')}}">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <input  type="number" name="mobile" placeholder="+63 123456789"  class="form-control">
                            </div>
                        </div>
						<div class="col-sm-6">
						<div class="form-group">    
     						 
							<select class="form-control" id="Subject" name="Subject" required focus>
                  							<option value="Tech Support"  selected>Tech Support</option>        
                  							<option value="Schedule Training"  selected>Schedule Training</option>        
