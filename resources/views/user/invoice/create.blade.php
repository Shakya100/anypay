        ...
        <div class="card">
          ...
          <div class="card-body">
            <form action="{{route('submit.invoice')}}" method="post">
              ...
              <div class="form-group row">
                ...
                <div class="col-lg-4">
                  <div class="input-group">
                    ...
                    <?php
                      if(!empty($invoiceno)){
                        $invoiceNo = $invoiceno->invoice_no +1;
                      }else{
                        $invoiceNo =0001;
                      }
                    ?>
                    <input type="number" name="invoice_no" class="form-control" value="<?= $invoiceNo;?>" readonly placeholder="123456"
						   required>
                  </div>
                </div>
              </div>               
              ...
              <div class="text-left">
                <button type="submit" class="btn btn-neutral btn-sm">{{__('Submit')}}</a>
              </div>         
            </form>
          </div>
        </div>
