                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 m-15px-tb">
                        ...
                        <div class="row">             
                            ...
                            <div class="col-lg-4 m-15px-tb">
                                <h5 class="footer-title">
                                {{__('Start Accepting These Cards Today!')}}
                                </h5>
                                <ul class="list-unstyled links-dark footer-link-1">
									<img src="https://anypay.ph/card.jpg">
...
@endif
<script type="text/javascript"  src="https://apiv2.popupsmart.com/api/Bundle/382003" async></script>
</body>
</html>